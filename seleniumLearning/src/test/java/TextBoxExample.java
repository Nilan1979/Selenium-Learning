...
public class TextBoxExample {
    ...
    public void textBoxTests(){
        ...
        WebElement textElement = driver.findElement(By.xpath("//*[@id='j_idt88:j_idt97']"));
        ...
        driver.findElement(By.id("j_idt88:j_idt99")).sendKeys("nilanuyangoda@gmail.com"+ Keys.TAB + "Confirm control moved to next element.");
